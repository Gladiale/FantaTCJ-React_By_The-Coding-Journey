...
import { type ProductsDataType } from "../../types/types";
...
const ProductsData: ProductsDataType[] = [
  {
    ...
    title: "Orange Fanta",
    image: P1,
    desc: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa similique dolor sunt debitis, numquam, esse possimus veniam quia magni, iste beatae!",
    delay: 0.5,
  },
  {
    id: 2,
